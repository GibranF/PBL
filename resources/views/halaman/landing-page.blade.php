...
<body class="index-page">
    ...
    <main class="main">
                ...
                <div class="slide">
                    ...
                    <div class="item side-slide" style="background-image: url('assets/img/karpet.png');">
                        <div class="content">
                            ...
                            <div class="des">Kami menjaga kualitas setiap cucian karpet agar tetap harum dan terawat,
                                mengembalikan keindahan dan kebersihannya.</div>
                    ...
                    <div class="item side-slide" style="background-image: url('assets/img/koin.png');">
                        <div class="content">
                            ...
                            <div class="des">Nikmati layanan self-service yang cepat dan efisien dengan mesin cuci dan
                                pengering modern kami.</div>
                            <button>Selengkapnya</button>
                        </div>
                    </div>
                    ...
                    <div class="item side-slide" style="background-image: url('assets/img/antarjemput.png');">
                        <div class="content">
                            ...
                            <div class="des">Layanan antar jemput kami memudahkan Anda untuk mencuci pakaian tanpa perlu
                                keluar rumah. Cucian dijemput dan diantar kembali dalam kondisi bersih dan rapi.</div>
                            <button>Selengkapnya</button>
                        </div>
                    </div>
        ...
        <section id="mengapa" class="py-5 text-white" style="background: linear-gradient(135deg, #9b5de5, #f15bb5);">
            <div class="container" data-aos="fade-up">
                <div class="section-title text-center mb-5">
                    <h2>Mengapa Harus <span class="text-warning">Istana Laundry?</span></h2>
                    <p class="text-white">
                        Istana Laundry adalah solusi laundry terpercaya di sekitar Anda dengan layanan profesional dan
                        standar tinggi.
                    </p>
                </div>
        ...
        <section id="features" class="features section">
            ...
            @else
                @php
                    $barisAtas = $layanan->take(20);
                    $barisBawah = $layanan->slice(20);
                @endphp
                ...
                <div class="container service-container service-container-top" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-wrapper">
                        ...
                        @foreach ($barisAtas as $item)
                                    <div class="service-card-wrapper">
                                        <div class="card service-card" style="width: 18rem; border-radius: 16px; overflow: hidden;">
                                            <img src="{{ $item->gambar
                            ? asset('storage/' . $item->gambar)
                            : asset('images/layanan/defaultlayanan.png') }}" class="card-img-top" alt="{{ $item->nama_layanan }}"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-price">
                                                    ...
                                                    <span style="color:#777; font-size:14px;">/ {{ $item->satuan }}</span>
                                                </p>

                                                <a href="{{ route('customer.pesanan.create', $item->id_layanan) }}"
                ...
                <!-- === BARIS BAWAH === -->
                @if($barisBawah->isNotEmpty())
                    <div class="container service-container service-container-bottom mt-4" data-aos="fade-up"
                        data-aos-delay="100">
                        <div class="service-wrapper">

                            @foreach ($barisBawah as $item)
                                    <div class="service-card-wrapper">
                                        <div class="card service-card" style="width: 18rem; border-radius: 16px; overflow: hidden;">
                                            ...
                                            <img src="{{ $item->gambar
                                ? asset('storage/' . $item->gambar)
                                : asset('images/layanan/defaultlayanan.png') }}" class="card-img-top"
                ...
                <div class="col-lg-10 text-center">
                    <div class="cta-card p-5 rounded-4 position-relative overflow-hidden">
                        <div class="cta-content position-relative z-index-2">
                            ...
                            <p class="mb-4 fs-5">Nikmati layanan cepat, profesional, dan nyaman dalam beberapa langkah
                                mudah!</p>

                            <div class="row text-start mb-4">
                                <div class="col-md-3 mb-3">
                                    <h5 class="fw-bold text-white"><i class="bi bi-bag-fill me-2"></i>1. Masukkan
                                        Pakaian</h5>
                                    <p class="text-white">Serahkan pakaian kotor Anda ke kami, baik secara langsung atau
                                        lewat layanan antar jemput.</p>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <h5 class="fw-bold text-white"><i class="bi bi-brush-fill me-2"></i>2. Proses
                                        Pencucian</h5>
                                    <p class="text-white">Pakaian dicuci dengan deterjen ramah lingkungan dan staf
                                        profesional untuk hasil bersih maksimal.</p>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <h5 class="fw-bold text-white"><i class="bi bi-clock-fill me-2"></i>3. Setrika &
                                        Periksa</h5>
                                    <p class="text-white">Setiap pakaian diperiksa dan disetrika agar rapi dan siap
                                        pakai.</p>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <h5 class="fw-bold text-white"><i class="bi bi-truck me-2"></i>4. Pengantaran /
                                        Ambil</h5>
                                    <p class="text-white">Pakaian siap diambil atau kami antar kembali ke alamat Anda
                        ...
                        <div class="accordion" id="faqAccordionLeft">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapse1" class="accordion-collapse collapse" aria-labelledby="faqHeading1"
                                    ...
                                    <div class="accordion-body">
                                        Kami menyediakan layanan cuci pakaian harian, cuci sepatu, setrika, dan layanan
                                        kiloan.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapse2" class="accordion-collapse collapse" aria-labelledby="faqHeading2"
                                    data-bs-parent="#faqAccordionLeft">
                                    <div class="accordion-body">
                                        Pakaian biasanya selesai dalam 24 jam, tergantung jenis layanan dan jumlah
                                        pakaian.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapse3" class="accordion-collapse collapse" aria-labelledby="faqHeading3"
                                    data-bs-parent="#faqAccordionLeft">
                                    <div class="accordion-body">
                                        Ya, kami menyediakan layanan antar-jemput untuk area tertentu. Silakan hubungi
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapse4" class="accordion-collapse collapse" aria-labelledby="faqHeading4"
                                    data-bs-parent="#faqAccordionLeft">
                                    <div class="accordion-body">
                                        Pembayaran dapat dilakukan secara tunai di tempat atau melalui transfer
                                        bank/e-wallet.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion" id="faqAccordionRight">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapse6" class="accordion-collapse collapse" aria-labelledby="faqHeading6"
                                    ...
                                    <div class="accordion-body">
                                        Ya, kami menggunakan deterjen dan produk ramah lingkungan yang aman untuk
                                        pakaian dan kulit.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqHeading7">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#faqCollapse7" aria-expanded="false"
                                ...
                                <div id="faqCollapse7" class="accordion-collapse collapse" aria-labelledby="faqHeading7"
                                    data-bs-parent="#faqAccordionRight">
                                    <div class="accordion-body">
                                        Kami bertanggung jawab penuh dan menyediakan kompensasi sesuai kebijakan jika
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqHeading8">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#faqCollapse8" aria-expanded="false"
                                ...
                                <div id="faqCollapse8" class="accordion-collapse collapse" aria-labelledby="faqHeading8"
                                    data-bs-parent="#faqAccordionRight">
                                    <div class="accordion-body">
                                        Ya, kami memiliki promo khusus untuk pelanggan tetap dan musiman. Silakan cek
                                        media sosial kami untuk info terbaru.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqHeading9">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#faqCollapse9" aria-expanded="false"
                                ...
                                <div id="faqCollapse9" class="accordion-collapse collapse" aria-labelledby="faqHeading9"
                                    data-bs-parent="#faqAccordionRight">
                                    <div class="accordion-body">
                                        Bisa, kami melayani cuci kiloan dan pesanan dalam jumlah besar sesuai kebutuhan
                                        pelanggan.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqHeading10">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#faqCollapse10" aria-expanded="false"
                                ...
                                <div id="faqCollapse10" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        Anda bisa menghubungi kami melalui telepon, WhatsApp, atau kunjungi langsung
                                        cabang terdekat.
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container" style="max-width: 800px;">
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <form method="GET" action="#komentar" class="d-flex">
                        <select name="filter_rating" class="form-select" onchange="this.form.submit()"
                            style="margin-left: 15px;"> <!-- tambah margin-left -->
                    ...
                    <div class="border p-3 mb-3 rounded shadow-sm">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="d-flex align-items-center">
                                ...
                                <img src="{{ $ulasan->user->profile_photo ? asset('storage/' . $ulasan->user->profile_photo) : asset('images/default-foto.png') }}"
                                    alt="Foto {{ $ulasan->user->name }}" class="rounded-circle me-2"
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg"> <!-- Tambah modal-lg -->
                                <div class="modal-content bg-transparent border-0">
                                    <div class="modal-body text-center">
                                        <img src="{{ $ulasan->user->profile_photo ? asset('storage/' . $ulasan->user->profile_photo) : asset('images/default-foto.png') }}"
                                            alt="Foto {{ $ulasan->user->name }}" class="img-fluid rounded"
                        ...
                        @if (Auth::check() && $ulasan->id_user == Auth::id())
                            <div class="d-flex justify-content-end gap-2 mt-3">
                                <!-- Edit -->
                                <button class="btn btn-sm btn-warning px-3" data-bs-toggle="collapse"
                ...
                <div class="mt-4 d-flex justify-content-center">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $ulasans->previousPageUrl() }}#komentar"
                            ...
                            @if ($ulasans->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $ulasans->nextPageUrl() }}#komentar"
                                        rel="next">Selanjutnya &raquo;</a>
                                </li>
                            @else
                                <li class="page-item disabled">
