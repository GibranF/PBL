...
@section('content')
    <div class="container-fluid py-3">
        ...
        <div class="pb-2 mb-3 border-bottom">
            <h4 class="fw-bold mb-0 text-primary">Detail Transaksi</h4>
            <small class="text-muted">Informasi lengkap transaksi laundry</small>
        </div>
        ...
        <div class="card shadow-sm border-0 rounded-0">
            ...
            <div class="card-body pb-1">
                ...
                {{-- LAYANAN --}}
                <span class="badge px-3 py-2 mt-4 mb-2" style="background:#e8eaff; color:#3f4dff; border-radius:0;">
                    Daftar Layanan
                </span>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped rounded-0">
                        <thead style="background:#f3f4ff;">
                            <tr>
                                <th class="text-primary">Layanan</th>
                                <th class="text-primary">Qty</th>
                                <th class="text-primary">Dimensi</th>
                                <th class="text-primary">Harga</th>
                                <th class="text-primary text-end">Subtotal</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                @if ($transaksi->biaya_antar > 0)
                    <span class="badge px-3 py-2 my-3" style="background:#e8eaff; color:#3f4dff; border-radius:0;">
                        Biaya Antar Jemput
                    </span>
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        <th class="fw-bold text-primary">Total Akhir</th>
