...
<head>
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="assets/img/favicon.png" type="image/x-icon"> <!-- [Google Font] Family -->
...
<nav class="pc-sidebar">
  <div class="m-header">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        <li class="pc-item">
          <a href="{{ url('/owner/dashboard') }}" class="pc-link">
        ...
        <li class="pc-item">
          <a href="{{ url('/owner/laporan') }}" class="pc-link">
        ...
        <li class="pc-item">
          <a href="{{ url('/owner/pengeluaran') }}" class="pc-link">
...
<!-- [ Header ] end -->
      ...
      <div class="row">
        ...
        <div class="col-auto my-1">
          <ul class="list-inline footer-link mb-0">
            <li class="list-inline-item"><a href="{{ asset('temp/dist')}}/index.html">Home</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <script src="{{ asset('temp/dist')}}/assets/js/plugins/feather.min.js"></script>
    {{-- Tambahkan ini supaya script dari child Blade jalan --}}
  @stack('scripts')
