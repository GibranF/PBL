...
Route::middleware(['auth', 'userMiddleware'])
    ...
    ->group(function () {
        ...
        Route::get(
            'pesanan/create/{id_layanan?}',
            [PesananCustomerController::class, 'create']
        )->name('customer.pesanan.create');
        Route::get(
            'pesanan/{id_transaksi}/detail',
            [PesananCustomerController::class, 'detail']
        )->name('customer.pesanan.detail');
        ...
        // ========== ROUTE PEMBAYARAN ==========
        Route::get('pembayaran/create/{id_transaksi}', [PembayaranController::class, 'create'])
            ->name('pembayaran.create');
        Route::post('pembayaran/store/{id_transaksi}', [PembayaranController::class, 'store'])
            ->name('customer.pembayaran.store');
...
Route::middleware(['auth', 'adminMiddleware'])
    ...
    ->group(function () {
        ...
        Route::get(
            'pesanan/{id_transaksi}/detail',
            [PesananAdminController::class, 'detail']
        ...
        Route::get('layanan/{id_layanan}/edit', [LayananController::class, 'edit'])->name('admin.layanan.edit');
        Route::put('layanan/{id_layanan}/update', [LayananController::class, 'update'])->name('admin.layanan.update');
